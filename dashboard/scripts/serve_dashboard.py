...
<div class="next-action"><div class="num">3</div><div class="action-copy"><strong>Preserve capital discipline</strong>Stay flat until setup quality is real.</div></div>'''
        ...
        compact_style = '''<style>body{margin:0;padding:0;background:#070b11;color:#e8eef8;font-family:Inter,sans-serif;overflow:hidden}.shell{height:100vh;display:grid;grid-template-rows:76px 1fr;padding:10px;gap:10px;background:radial-gradient(circle at top,#122033 0%,#070b11 58%)}.topbar{display:grid;grid-template-columns:1.2fr .9fr .95fr;gap:10px}.topcard,.mode-rail,.workspace,.drawer,.subpanel{background:linear-gradient(180deg,#101722,#0b1017);border:1px solid #1d2b3f;border-radius:18px;box-shadow:0 14px 36px rgba(0,0,0,.28)}.topcard{display:flex;align-items:center;justify-content:space-between;padding:12px 16px}.brand-k{font-size:10px;letter-spacing:.18em;text-transform:uppercase;color:#f59e0b;font-weight:800}.brand-v{font-size:26px;font-weight:800;line-height:1}.brand-s{font-size:12px;color:#8ea2bd;margin-top:4px}.status-strip{display:flex;gap:8px;flex-wrap:wrap;justify-content:flex-end}.pill{display:inline-flex;align-items:center;gap:8px;padding:9px 12px;border-radius:999px;background:#0b1320;border:1px solid #24354c;font-size:11px;font-weight:700;color:#dbe7f5}.shell-body{display:grid;grid-template-columns:78px 1fr 340px;gap:10px;min-height:0}.mode-rail{padding:10px;display:grid;grid-template-rows:auto 1fr auto;gap:10px}.mode-stack,.quick-stack{display:grid;gap:8px}.railbtn,.quickbtn,.toolbtn,.tabbtn{border:1px solid #24354c;background:#101827;color:#e8eef8;border-radius:14px;cursor:pointer;transition:all .15s ease;font-weight:700}.railbtn{height:58px;font-size:10px;letter-spacing:.12em;text-transform:uppercase}.railbtn.active,.tabbtn.active,.quickbtn.active{border-color:#38bdf8;background:linear-gradient(180deg,#16314d,#102033);box-shadow:0 10px 20px rgba(0,0,0,.28)}.workspace{display:grid;grid-template-rows:auto 1fr;min-height:0;overflow:hidden}.workspace-head{display:flex;justify-content:space-between;align-items:center;padding:12px 16px;border-bottom:1px solid rgba(61,78,102,.35)}.workspace-title{font-size:13px;letter-spacing:.14em;text-transform:uppercase;color:#c5d3e7;font-weight:800}.workspace-sub{font-size:11px;color:#7f92ac}.workspace-main{padding:12px;display:grid;grid-template-rows:auto auto 1fr;gap:10px;min-height:0}.hero-grid{display:grid;grid-template-columns:1.25fr .75fr;gap:10px}.directive{padding:18px;border-radius:16px;background:linear-gradient(135deg,rgba(56,189,248,.14),rgba(12,18,26,.92));border:1px solid rgba(56,189,248,.22)}.directive-k{font-size:10px;letter-spacing:.16em;text-transform:uppercase;color:#7dd3fc;margin-bottom:8px;font-weight:800}.directive-v{font-size:32px;font-weight:800;line-height:1.03}.directive-p{font-size:13px;color:#9cb0c9;margin-top:8px}.hero-side{display:grid;gap:10px}.action-banner{padding:14px;border-radius:16px;background:linear-gradient(180deg,#34141b,#1a1014);border:1px solid #6d2b3a;color:#fecaca;font-size:12px;font-weight:700}.mini-metrics{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px}.metric{padding:12px;border-radius:14px;background:#0d1521;border:1px solid #1d2a3b}.metric-k{font-size:10px;letter-spacing:.12em;text-transform:uppercase;color:#7f92ac}.metric-v{font-size:20px;font-weight:800;margin-top:4px}.metric-s{font-size:11px;color:#95a8c0;margin-top:4px}.view-tabs{display:flex;gap:8px;flex-wrap:wrap}.tabbtn,.quickbtn,.toolbtn{padding:10px 12px;font-size:12px}.toolbtn.danger{border-color:#6b2936;background:#25141a;color:#ffd1d5}.toolbtn.busy{opacity:.6;pointer-events:none}.view-pane{display:none;min-height:0}.view-pane.active{display:grid}.overview-grid{display:grid;grid-template-columns:1.15fr .85fr;gap:10px;min-height:0}.subpanel{display:flex;flex-direction:column;min-height:0}.subpanel-head{display:flex;justify-content:space-between;align-items:center;padding:10px 12px;border-bottom:1px solid rgba(61,78,102,.35)}.subpanel-title{font-size:11px;letter-spacing:.12em;text-transform:uppercase;color:#c7d3e4;font-weight:800}.subpanel-sub{font-size:10px;color:#7f92ac}.subpanel-body{padding:12px;min-height:0;overflow:auto}.kv{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.kv div{padding:10px;border-radius:12px;background:#0d1521;border:1px solid #1d2a3b}.kv span{display:block;font-size:10px;color:#7f92ac;margin-bottom:4px}.list{display:grid;gap:8px}.list-item{padding:10px;border-radius:12px;background:#0d1521;border:1px solid #1d2a3b}.compact-pre{white-space:pre-wrap;overflow:auto;background:#09101a;padding:10px;border-radius:12px;border:1px solid #24354c;font-size:10px;max-height:260px}.drawer{display:grid;grid-template-rows:auto auto 1fr;gap:10px;padding:10px;min-height:0}.drawer-card{background:#0d1521;border:1px solid #1d2a3b;border-radius:16px;display:flex;flex-direction:column;min-height:0}.drawer-head{display:flex;justify-content:space-between;align-items:center;padding:10px 12px;border-bottom:1px solid rgba(61,78,102,.35)}.drawer-body{padding:12px;min-height:0;overflow:auto}.statusline,.micro{font-size:11px;color:#93a6bf}.slim-input,.slim-textarea{width:100%;background:#09101a;color:#e8eef8;border:1px solid #24354c;border-radius:12px;padding:10px}.slim-textarea{min-height:160px;font-family:'JetBrains Mono',monospace;font-size:11px}.toolbar{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:10px}.footer-note{padding-top:8px;font-size:10px;color:#7f92ac}.hide{display:none}.scroll{overflow:auto;min-height:0}@media (max-width:1280px){body{overflow:auto}.shell{height:auto}.topbar,.shell-body,.hero-grid,.overview-grid,.mini-metrics,.toolbar,.kv{grid-template-columns:1fr}.shell-body{grid-template-columns:1fr}.mode-rail{grid-template-columns:repeat(3,1fr);grid-template-rows:auto}.mode-stack,.quick-stack{grid-template-columns:repeat(3,1fr)}}@media (max-width:860px){.mode-rail{grid-template-columns:repeat(2,1fr)}.view-tabs,.status-strip{display:grid;grid-template-columns:1fr 1fr}}</style>'''
        ...
        control_script = '''<script>(function(){ function setText(id, value){ var el=document.getElementById(id); if(el) el.textContent=value; } function pretty(value){ try { return JSON.stringify(value || {}, null, 2); } catch(err){ return String(value || ''); } } function setBusy(command, busy){ document.querySelectorAll('[data-command]').forEach(function(btn){ if(btn.getAttribute('data-command') === command){ btn.classList.toggle('busy', busy); btn.textContent = busy ? 'Running…' : btn.getAttribute('data-label'); } }); } function setLatestResult(data){ var latest = data && data.latest_result ? data.latest_result : null; var recent = data && data.recent_events ? data.recent_events : []; setText('latest-result-title', latest ? (latest.event_type || latest.kind || 'Latest event') : 'Waiting for action'); setText('latest-result-message', latest ? (latest.summary || latest.message || latest.details || 'No summary available') : 'Run a command or inspect system output.'); setText('latest-result-json', pretty(latest || {})); setText('recent-events-box', pretty(recent)); setText('recent-events-box-secondary', pretty(recent)); } function showView(name){ document.querySelectorAll('[data-view]').forEach(function(btn){ btn.classList.toggle('active', btn.getAttribute('data-view') === name); }); document.querySelectorAll('.railbtn').forEach(function(btn){ btn.classList.toggle('active', (btn.textContent || '').trim().toLowerCase() === name); }); document.querySelectorAll('.view-pane').forEach(function(pane){ pane.classList.toggle('active', pane.id === 'view-' + name); }); } async function runCommand(command){ setText('command-status', 'Running ' + command + '...'); setBusy(command, true); try { const res = await fetch('/api/command', {method:'POST', headers:{'Content-Type':'application/json'}, body: JSON.stringify({command: command})}); const data = await res.json(); setText('command-status', data.message || data.error || ('Command ' + command + ' finished')); await loadOverview(); if(command === 'refresh_truth' && res.ok){ setTimeout(function(){ window.location.reload(); }, 900); } } catch(err){ setText('command-status', 'Command failed: ' + err.message); } finally { setBusy(command, false); } } async function loadOverview(){ try { const res = await fetch('/api/hq/overview', {cache:'no-store'}); const data = await res.json(); document.querySelectorAll('#hq-config-input').forEach(function(cfg){ cfg.value = JSON.stringify(data.safety_config || {}, null, 2); }); setText('refresh-status-box', pretty(data.refresh_status || {})); setText('action-feedback-box', pretty(data.action_feedback || {})); setText('notes-log-box', (data.notes || []).join('\n')); setText('signals-log-box', (data.signals || []).join('\n')); setText('trades-log-box', (data.trades || []).join('\n')); setText('refresh-log-box', (data.refresh_log || []).join('\n')); setLatestResult(data); setText('config-status', 'Config loaded'); } catch(err){ setText('config-status', 'Overview load failed: ' + err.message); setText('command-status', 'Overview load failed: ' + err.message); } } async function saveNote(){ var input=document.getElementById('hq-note-input'); var note=(input && input.value ? input.value : '').trim(); if(!note){ setText('note-status', 'Note is empty'); return; } try { const res = await fetch('/api/hq/notes',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({note: note})}); const data = await res.json(); setText('note-status', data.message || data.error || 'Note saved'); if(res.ok && input){ input.value=''; await loadOverview(); } } catch(err){ setText('note-status', 'Note save failed: ' + err.message); } } async function saveConfig(){ var raw=(document.getElementById('hq-config-input') || {}).value || ''; try { const parsed=JSON.parse(raw); const res=await fetch('/api/hq/config',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({config: parsed})}); const data=await res.json(); setText('config-status', data.message || data.error || 'Config saved'); if(res.ok){ await loadOverview(); } } catch(err){ setText('config-status', 'Config save failed: ' + err.message); } } function showTab(name){ document.querySelectorAll('.tabbtn[data-tab]').forEach(function(btn){ btn.classList.toggle('active', btn.getAttribute('data-tab') === name); }); document.querySelectorAll('.tabpane').forEach(function(pane){ pane.classList.toggle('active', pane.id === 'tab-' + name); }); } window.runCommand=runCommand; window.saveNote=saveNote; window.saveConfig=saveConfig; window.loadOverview=loadOverview; window.showTab=showTab; window.showView=showView; if(document.readyState === 'loading'){ document.addEventListener('DOMContentLoaded', function(){ loadOverview(); showView('overview'); }); } else { loadOverview(); showView('overview'); } })();</script>'''
        ...
        <section class="shell-body">
            <aside class="mode-rail">
                ...
                <div class="quick-stack">
                    <button class="quickbtn" type="button" data-command="refresh_truth" data-label="Refresh" onclick="runCommand('refresh_truth')">Refresh</button>
                    <button class="quickbtn" type="button" data-command="diagnose_tradier" data-label="Tradier diag" onclick="runCommand('diagnose_tradier')">T diag</button>
                    <button class="quickbtn" type="button" data-command="diagnose_bloc" data-label="Bloc diag" onclick="runCommand('diagnose_bloc')">B diag</button>
                    <button class="quickbtn" type="button" data-command="pause_bloc" data-label="Pause Bloc" onclick="runCommand('pause_bloc')">Pause</button>
                    <button class="quickbtn" type="button" data-command="resume_bloc" data-label="Resume Bloc" onclick="runCommand('resume_bloc')">Resume</button>
                    <button class="quickbtn active" type="button" data-command="close_all" data-label="Close all" onclick="runCommand('close_all')">Close</button>
                </div>
            </aside>
            <main class="workspace">
                ...
                <div class="workspace-main">
                    ...
                    <div id="view-tradier" class="view-pane overview-grid">
                        ...
                        <div class="subpanel"><div class="subpanel-head"><div><div class="subpanel-title">Tradier actions</div><div class="subpanel-sub">Immediate controls</div></div></div><div class="subpanel-body"><div class="toolbar"><button class="toolbtn" type="button" data-command="diagnose_tradier" data-label="Tradier diag" onclick="runCommand('diagnose_tradier')">Run Tradier diagnostic</button><button class="toolbtn danger" type="button" data-command="close_all" data-label="Close all" onclick="runCommand('close_all')">Emergency close</button></div><pre id="tradier-detail-box" class="compact-pre">Tradier execution panel is the next build target.</pre></div></div>
                    </div>
                    <div id="view-bloc" class="view-pane overview-grid">
                        <div class="subpanel"><div class="subpanel-head"><div><div class="subpanel-title">Bloc workstation</div><div class="subpanel-sub">Runtime, inventory, and intervention</div></div></div><div class="subpanel-body"><div class="kv"><div><span>Status</span>{esc(status)}</div><div><span>Deployable</span>{money(deployable)}</div><div><span>Holding</span>{esc(holding_asset + (' ' + str(holding_units) if holding_units is not None and holding_asset else ''))}</div><div><span>Feed</span>{esc(reality_feed)}</div></div></div></div>
                        <div class="subpanel"><div class="subpanel-head"><div><div class="subpanel-title">Bloc actions</div><div class="subpanel-sub">Control lane</div></div></div><div class="subpanel-body"><div class="toolbar"><button class="toolbtn" type="button" data-command="diagnose_bloc" data-label="Bloc diag" onclick="runCommand('diagnose_bloc')">Run Bloc diagnostic</button><button class="toolbtn" type="button" data-command="pause_bloc" data-label="Pause Bloc" onclick="runCommand('pause_bloc')">Pause Bloc</button><button class="toolbtn" type="button" data-command="resume_bloc" data-label="Resume Bloc" onclick="runCommand('resume_bloc')">Resume Bloc</button></div><pre class="compact-pre">Bloc intervention and parameter edit lane belongs here.</pre></div></div>
                    </div>
                    <div id="view-journal" class="view-pane overview-grid">
                        <div class="subpanel"><div class="subpanel-head"><div><div class="subpanel-title">Operator notes</div><div class="subpanel-sub">Write it down</div></div></div><div class="subpanel-body">{notes_html}</div></div>
                        <div class="subpanel"><div class="subpanel-head"><div><div class="subpanel-title">Positions and activity</div><div class="subpanel-sub">Trail and review</div></div></div><div class="subpanel-body"><div class="view-tabs"><button class="tabbtn active" type="button" data-tab="positions" onclick="showTab('positions')">Positions</button><button class="tabbtn" type="button" data-tab="activity" onclick="showTab('activity')">Activity</button></div><div id="tab-positions" class="tabpane active"><div class="list">{positions_html}</div></div><div id="tab-activity" class="tabpane"><div class="list">{events_html}</div></div></div></div>
                    </div>
                    <div id="view-logs" class="view-pane overview-grid">
                        <div class="subpanel"><div class="subpanel-head"><div><div class="subpanel-title">System logs</div><div class="subpanel-sub">Signals, trades, refresh</div></div></div><div class="subpanel-body">{logs_html}</div></div>
                        <div class="subpanel"><div class="subpanel-head"><div><div class="subpanel-title">Recent pulse</div><div class="subpanel-sub">Event stream</div></div></div><div class="subpanel-body"><pre id="recent-events-box-secondary" class="compact-pre">--</pre></div></div>
                    </div>
                    <div id="view-settings" class="view-pane overview-grid">
                        <div class="subpanel"><div class="subpanel-head"><div><div class="subpanel-title">Safety config</div><div class="subpanel-sub">Risk and operating limits</div></div></div><div class="subpanel-body">{config_html}</div></div>
                        <div class="subpanel"><div class="subpanel-head"><div><div class="subpanel-title">Execution stats</div><div class="subpanel-sub">Today, not vibes</div></div></div><div class="subpanel-body">{scoreboard_panel_html}</div></div>
                    </div>
                </div>
            </main>
            <aside class="drawer">
                <div class="drawer-card"><div class="drawer-head"><strong>Command deck</strong><span class="pill">LIVE</span></div><div class="drawer-body"><div class="toolbar">{controls_html}</div><div class="statusline" style="margin-top:10px;">Button actions write into the live result workspace.</div></div></div>
                <div class="drawer-card"><div class="drawer-head"><strong>Quick config</strong></div><div class="drawer-body">{config_html}</div></div>
                <div class="drawer-card"><div class="drawer-head"><strong>Operator note</strong></div><div class="drawer-body">{notes_html}</div></div>
            </aside>
        </section>
    </div>
    {control_script}
