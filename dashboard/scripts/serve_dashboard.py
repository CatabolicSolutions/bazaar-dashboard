...
<div class="next-action"><div class="num">3</div><div class="action-copy"><strong>Preserve capital discipline</strong>Stay flat until setup quality is real.</div></div>'''
        ...
        result_center_html = '''<section class="panel" style="min-height:340px;"><div class="panel-head"><div><div class="panel-title">Live result workspace</div><div class="panel-sub">What the last command or system action actually did</div></div><span class="badge">RESULT</span></div><div class="primary-stage"><div class="directive" style="padding:12px;"><div class="directive-k">Latest result</div><div class="directive-v" id="latest-result-title" style="font-size:20px;">Waiting for action</div><div class="directive-p" id="latest-result-message">Run a command or inspect system output.</div></div><div class="split"><div class="panel" style="min-height:200px;"><div class="panel-head"><div><div class="panel-title">Command response</div><div class="panel-sub">Structured latest event</div></div></div><div class="logs-wrap"><pre id="latest-result-json" class="compact-pre">--</pre></div></div><div class="panel" style="min-height:200px;"><div class="panel-head"><div><div class="panel-title">System pulse</div><div class="panel-sub">Recent event stream</div></div></div><div class="logs-wrap"><pre id="recent-events-box" class="compact-pre">--</pre></div></div></div></div></section>'''
    ...
    <div class="shell">
        ...
        <div class="desk">
            <aside class="panel left-rail scroll">
                ...
                <div class="scroll" style="padding:10px;">{scoreboard_panel_html}</div>
