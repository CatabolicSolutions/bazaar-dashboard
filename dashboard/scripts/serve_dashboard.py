...
<div class="next-action"><div class="num">3</div><div class="action-copy"><strong>Preserve capital discipline</strong>Stay flat until setup quality is real.</div></div>'''
        ...
        compact_style = '''<style>.shell{max-width:1400px}.hero{padding:12px}.status-strip{grid-template-columns:repeat(5,minmax(0,1fr));gap:8px}.pill-card{padding:10px}.decision{padding:12px}.grid{grid-template-columns:1fr 1fr;align-items:start}.stack{gap:10px}.section{padding:12px}.section-title{font-size:13px}.section-sub,.pill-sub,.meta-row,.ops-summary{font-size:11px}.toolbar{grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.toolbtn{padding:10px;font-size:12px}.kv{grid-template-columns:repeat(3,minmax(0,1fr));gap:6px}.kv div{padding:7px}.ops-item{padding:10px}.position-row,.activity-row,.next-action{padding:8px}.mini-stat{padding:8px}.mini-stat .value{font-size:14px}.dense-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}.dense-card{background:rgba(255,255,255,0.02);border:1px solid rgba(148,163,184,0.12);border-radius:10px;padding:10px}.dense-card h3{font-size:12px;text-transform:uppercase;letter-spacing:.08em;margin-bottom:8px}.compact-pre{white-space:pre-wrap;max-height:140px;overflow:auto;background:#0f172a;padding:8px;border-radius:8px;border:1px solid #22304a;font-size:11px}.slim-input{width:100%;background:#0f172a;color:#e5edf7;border:1px solid #22304a;border-radius:8px;padding:8px}.slim-textarea{width:100%;background:#0f172a;color:#e5edf7;border:1px solid #22304a;border-radius:8px;padding:8px;font-family:monospace}.top-controls{display:grid;grid-template-columns:2fr 1fr;gap:10px}.micro-status{font-size:11px;color:var(--text-dim);margin-top:6px}@media (max-width:1100px){.status-strip,.decision-grid,.grid,.toolbar,.kv,.dense-grid,.top-controls{grid-template-columns:1fr}}</style>'''
        controls_html = '''<section class="card section"><div class="section-head"><div><div class="section-title">Operator controls</div><div class="section-sub">Fast actions</div></div></div><div class="toolbar"><button class="toolbtn" type="button" onclick="runCommand('refresh_truth')">Refresh</button><button class="toolbtn" type="button" onclick="runCommand('diagnose_tradier')">Tradier diag</button><button class="toolbtn" type="button" onclick="runCommand('diagnose_bloc')">Bloc diag</button><button class="toolbtn" type="button" onclick="runCommand('pause_bloc')">Pause Bloc</button><button class="toolbtn" type="button" onclick="runCommand('resume_bloc')">Resume Bloc</button><button class="toolbtn danger" type="button" onclick="runCommand('close_all')">Close all</button></div><div id="command-status" class="micro-status">No command run yet.</div></section>'''
