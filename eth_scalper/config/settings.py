...
BLOC_ROTATE_SIGNAL_LOOKBACK_POINTS = int(os.getenv('BLOC_ROTATE_SIGNAL_LOOKBACK_POINTS', '12'))
BLOC_ROTATE_SIGNAL_MOM_POINTS = int(os.getenv('BLOC_ROTATE_SIGNAL_MOM_POINTS', '3'))
BLOC_ROTATE_SIGNAL_MIN_EDGE_PCT = float(os.getenv('BLOC_ROTATE_SIGNAL_MIN_EDGE_PCT', '0.06'))
BLOC_ROTATE_SIGNAL_MIN_DEV_PCT = float(os.getenv('BLOC_ROTATE_SIGNAL_MIN_DEV_PCT', '0.03'))
BLOC_ROTATE_SIGNAL_MIN_SPREAD_MOVE_PCT = float(os.getenv('BLOC_ROTATE_SIGNAL_MIN_SPREAD_MOVE_PCT', '0.01'))
BLOC_ROTATE_SIGNAL_PERSIST_BARS = int(os.getenv('BLOC_ROTATE_SIGNAL_PERSIST_BARS', '2'))
BLOC_ARM_WAIT_SUPPRESS_DURING_ROTATE = os.getenv('BLOC_ARM_WAIT_SUPPRESS_DURING_ROTATE', 'true').lower() == 'true'
BLOC_ARM_WAIT_MIN_ROTATE_EDGE_PCT = float(os.getenv('BLOC_ARM_WAIT_MIN_ROTATE_EDGE_PCT', '0.18'))
